...
//   res.send(`N° Client ${ req.params.id }`)
// }

// const patchItem = (req, res) => {
//   res.send(`Enregistrement du client N° ${ req.params.id }`)
// }

// const postItem = (req, res) => {
//   res.send(`Création d'un nouveau client`)
// }

// const deleteItem = (req, res) => {
//   res.send(`Suppression du client N° ${ req.params.id }`)
// }
